...
namespace GMap.NET
{
   ...
   /// </summary>
   [Serializable]
  /* public struct PointLatLng_two
   {
      public static readonly PointLatLng_two Empty = new PointLatLng_two();
      private double lat;
      private double lng;

      bool NotEmpty;

      public PointLatLng_two(double lat, double lng)
      {
         this.lat = lat;
         this.lng = lng;
         NotEmpty = true;
      ...
      public static PointLatLng_two operator +(PointLatLng_two pt, SizeLatLng sz)
      {
         return Add(pt, sz);
      }
      ...
      public static SizeLatLng operator -(PointLatLng_two pt1, PointLatLng_two pt2)
      {
          return new SizeLatLng(pt1.Lat - pt2.Lat, pt2.Lng - pt1.Lng);
      }

      public static bool operator ==(PointLatLng_two left, PointLatLng_two right)
      {
      ...
      public static PointLatLng_two Add(PointLatLng_two pt, SizeLatLng sz)
      {
          return new PointLatLng_two(pt.Lat - sz.HeightLat, pt.Lng + sz.WidthLng);
      }

      public static PointLatLng_two Subtract(PointLatLng_two pt, SizeLatLng sz)
      {
          return new PointLatLng_two(pt.Lat + sz.HeightLat, pt.Lng - sz.WidthLng);
      }
      ...
      {
          if (!(obj is PointLatLng_two))
         {
            return false;
         }
          PointLatLng_two tf = (PointLatLng_two)obj;
         return (((tf.Lng == this.Lng) && (tf.Lat == this.Lat)) && tf.GetType().Equals(base.GetType()));
      }

      public void Offset(PointLatLng_two pos)
      {
