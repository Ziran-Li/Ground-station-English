...
namespace GeoServey
{
    public class GeoServey : GMapNetInterFace.IF_Plugin
    {
        ...
        string UrlFormatORT = "http://cyberjapandata.gsi.go.jp/xyz/ort/{0}/{1}/{2}.jpg";
        //string UrlFormat18 = "http://cyberjapandata.gsi.go.jp/xyz/std2012/{0}/{1}/{2}.png";
